...
function Chip({ text, link, size, type }) {
  return /* @__PURE__ */ createElement("button", {
    ...
    className: import_css.css`
        ...
        border-radius: 8px;
        background-color: ${type === "primary" ? tokens.color.main_green_10.value : tokens.color.grey_10_light.value};
        border: 1px solid ${tokens.color.grey_30_light.value};
        color: ${type === "primary" ? tokens.color.grey_5_light.value : tokens.color.grey_50_light.value};
        font-weight: 500;
        font-size: 16px;
        text-align: center;
