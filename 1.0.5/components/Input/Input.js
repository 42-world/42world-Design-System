...
function Input(_a) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", {
    className: containerStyle(theme, hasError)
  }, /* @__PURE__ */ React.createElement("span", {
    className: placeholderStyle(theme, isFocus, value.length > 0, hasError, onChangeless)
    ...
    onFocus: handleFocus,
    onBlur: handleBlur
  }, rest)))), hasError && /* @__PURE__ */ React.createElement("div", {
...
var placeholderStyle = (theme, isFocus, isTyping, isError, onChangeless) => import_css.css`
  ...
  color: ${isFocus && isTyping ? token.color.main_green_20 : theme === "light" ? token.color.grey_40_light : token.color.grey_40_dark};
