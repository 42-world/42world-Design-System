...
// src/components/SortSelector/SortSelector.tsx
var import_css = __toModule(require_emotion_css_cjs());
import { token } from "../../common/token/index.js";
var SortSelector = ({ list, theme, selectedIndex, onClick }) => {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      ...
      className: beforeItem(selectedIndex === index)
    }, "\u2022"), /* @__PURE__ */ React.createElement("text", {
      className: itemText(selectedIndex === index),
      onClick
    }, item.text));
  }));
};
var containerStyle = import_css.css`
  ...
  flex-direction: row;
`;
var beforeItem = (isFocus) => import_css.css`
  color: ${isFocus ? token.color.main_green_10 : token.color.grey_40_light};
  margin: 4px;
`;
var itemText = (isFocus) => import_css.css`
