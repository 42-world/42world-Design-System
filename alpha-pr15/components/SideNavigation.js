...
function SideNavigation({ theme, hasIcon, list, focus }) {
  ...
  return /* @__PURE__ */ createElement("div", {
    ...
    return /* @__PURE__ */ createElement("div", {
      ...
      className: import_css.css`
                font-size: 16px;
                color: ${focus === index ? tokens.color.main_green_10 : tokens.color.grey_40_light};
              ...
              `,
      href: list2.link
    }, list2.text), /* @__PURE__ */ createElement("div", {
      className: import_css.css`
                width: 3px;
                background-color: ${tokens.color.main_green_10};
                border-radius: 0px 2px 2px 0px;
                color: ${tokens.color.main_green_10};
...
var contaier = import_css.css`
  ...
  overflow: hidden;
`;
var itemContainer = import_css.css`
  display: flex;
  width: 100%;
